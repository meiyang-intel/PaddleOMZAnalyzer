...
if __name__ == '__main__':
    ...
    with open(os.path.abspath(os.path.join(__dir__, '../downloader/paddleseg_full.csv')), newline='') as csvfile:
        ...
        for row in reader:
            ...
            exported_path = os.path.abspath(os.path.join(__dir__, '../exporter/paddleseg/{}'.format(config_base)))
            print(exported_path)
    ...
    with open(os.path.join(__dir__, './paddleseg_operators.csv'), 'w', newline='') as csvfile:
