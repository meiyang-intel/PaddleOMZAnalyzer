...
def parse_args():
    ...
    default_static_models_path =os.path.abspath(os.path.join(__dir__, '../exporter/paddleclas'))
    default_result_save_file =os.path.abspath(os.path.join(__dir__, './paddleclas_filtered_operators.csv'))
...
def welcome_info(args):
    logging.info("paddle classification models analyzer begin.")
...
if __name__ == '__main__':
    main()
    logging.info("paddle classification models analyzer end.")
