...
def parse_args():
    ...
    parser.add_argument("--project_dir", type=str, default='../../PaddleDetection', help="PaddleDetection project directory")
    parser.add_argument("--filter_data_file", type=str, default='../data/paddledet.csv', help="The file we used to filter the model link")
    ...
    parser.add_argument("--models_download_path", type=str, default='./paddledet', help="where to store the downloaded models")
    parser.add_argument("--full_model_info_save_file", type=str, default='./paddledet_full.csv', help="The file to save the full model link info")
    parser.add_argument("--filtered_model_info_save_file", type=str, default='./paddledet_filtered.csv', help="The file to save the filtered model link info")
